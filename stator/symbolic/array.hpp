...
namespace sym
{
  ...
  struct Expr;
  template <>
  class Array<Expr, LinearAddressing<-1u>>;
  ...
  auto operator+(const Array<Args...> &l, const R &r)
  {
    if constexpr (std::is_base_of<detail::ArrayBase, R>())
      return detail::elementwiseopLR(l, r, [](const typename Array<Args...>::Value &l, const typename R::Value &r)
                                     { return l + r; });
    else
      return detail::elementwiseopL(l, r, [](const typename Array<Args...>::Value &l, const R &r)
                                    { return l + r; });
  }
  ...
  {
    return detail::elementwiseopR(l, r, [](const L &l, const typename Array<Args...>::Value &r)
                                  { return l + r; });
  }
  ...
  {
    return detail::elementwiseopLR(l, r, [](const typename Array<LArgs...>::Value &l, const typename Array<RArgs...>::Value &r)
                                   { return l * r; });
  }
  ...
  {
    return detail::elementwiseopL(l, r, [](const typename Array<LArgs...>::Value &l, const RHS &r)
                                  { return l * r; });
  }
  ...
  {
    return detail::elementwiseopR(l, r, [](const LHS &l, const typename Array<RArgs...>::Value &r)
                                  { return l * r; });
  }
