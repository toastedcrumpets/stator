...
BOOST_AUTO_TEST_CASE( poly_variables )
{
  ...
  BOOST_CHECK(compare_expression(x * x * x, "1 × x³"));
  BOOST_CHECK(compare_expression(y * y * y, "1 × y³"));
  BOOST_CHECK(compare_expression(substitution(y * y * y, Variable<'y'>()==Variable<'x'>()), "1 × x³"));
}
